...
Item {
    ...
    readonly property bool sholdBeVisible: Config.bar.persistent || visibilities.bar || isHovered
    ...
    transitions: [
        ...
        Transition {
            ...
            Anim {
                target: root
                property: "implicitWidth"
                easing.beazierCurve: Appearance.anim.curves.emphasized
            }
        }
    ]
    ...
    Loader {
        ...
        active: root.sholdBeVisible || root.visible

        sourceComponent: Bar {
            width: root.contentWidth
            screen: root.screen
            visibilties: root.visibilities
