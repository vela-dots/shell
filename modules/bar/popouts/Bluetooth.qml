    ...
    Repeater {
        ...
        RowLayout {
            ...
            StyledRect {
                ...
                color: Qt.alpha(Colors.palette.m3primary, device.modelData.state === BluetoothDeviceState.Connected ? 1 : 0)
                ...
                StateLayer {
                    color: device.modelData.state === BluetoothDeviceState.Connected ? Colors.palette.m3onPrimary : Colors.palette.m3onSurface
