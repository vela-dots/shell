...
ColumnLayout {
    ...
    RowLayout {
        ...
        StyledRect {
            ...
            color: Bluetooth.defaultAdapter?.discovering ? Colors.palette.m3secondary : Colors.palette.m3secondaryContainer

            StateLayer {
                color: Bluetooth.defaultAdapter?.discovering ? Colors.palette.m3onSecondary : Colors.palette.m3onSecondaryContainer
    ...
    StyledListView {
        ...
        delegate: StyledRect {
            ...
            color: Qt.alpha(Colors.tPalette.m3surfaceContainer, root.session.bt.active === modelData ? Colors.tPalette.m3surfaceContainer.a : 0)
            ...
            RowLayout {
                ...
                StyledRect {
                    ...
                    radius: Appearance.rounding.normal
                    color: device.connected ? Colors.palette.m3primaryContainer : device.modelData.bonded ? Colors.palette.m3secondaryContainer : Colors.tPalette.m3surfaceContainerHigh

                    StyledRect {
                        anchors.fill: parent
                        radius: parent.radius
                        color: Qt.alpha(device.connected ? Colors.palette.m3onPrimaryContainer : device.modelData.bonded ? Colors.palette.m3onSecondaryContainer : Colors.palette.m3onSurface, stateLayer.pressed ? 0.1 : stateLayer.containsMouse ? 0.08 : 0)
                    }
                    ...
                    MaterialIcon {
                        ...
                        color: device.connected ? Colors.palette.m3onPrimaryContainer : device.modelData.bonded ? Colors.palette.m3onSecondaryContainer : Colors.palette.m3onSurface
                        font.pointSize: Appearance.font.size.large
                ...
                StyledRect {
                    ...
                    color: Qt.alpha(Colors.palette.m3primaryContainer, device.connected ? 1 : 0)
                    ...
                    StateLayer {
                        color: device.connected ? Colors.palette.m3onPrimaryContainer : Colors.palette.m3onSurface
    ...
    component ToggleButton: StyledRect {
        ...
        color: toggled ? Colors.palette[`m3${accent.toLowerCase()}`] : Colors.palette[`m3${accent.toLowerCase()}Container`]

        StateLayer {
            id: toggleStateLayer

            color: toggleBtn.toggled ? Colors.palette[`m3on${toggleBtn.accent}`] : Colors.palette[`m3on${toggleBtn.accent}Container`]
