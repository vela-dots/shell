        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                StyledRect {
                    ...
                    color: Qt.alpha(Colors.palette.m3primary, root.session.bt.editingAdapterName ? 1 : 0)

                    StateLayer {
                        color: root.session.bt.editingAdapterName ? Colors.palette.m3onPrimary : Colors.palette.m3onSurface
