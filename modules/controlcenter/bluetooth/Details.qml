...
Item {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        StyledRect {
                            ...
                            color: Qt.alpha(Colors.palette.m3primary, root.session.bt.editingDeviceName ? 1 : 0)

                            StateLayer {
                                color: root.session.bt.editingDeviceName ? Colors.palette.m3onPrimary : Colors.palette.m3onSurface
    ...
    Item {
        ...
        StyledRect {
            ...
            radius: Appearance.rounding.normal
            color: root.session.bt.fabMenuOpen ? Colors.palette.m3primary : Colors.palette.m3primaryContainer
            ...
            StateLayer {
                ...
                color: root.session.bt.fabMenuOpen ? Colors.palette.m3onPrimary : Colors.palette.m3onPrimaryContainer
