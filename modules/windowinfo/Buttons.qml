            ...
            GridLayout {
                ...
                Repeater {
                    ...
                    Button {
                        ...
                        color: isCurrent ? Colors.tPalette.m3surfaceContainerHighest : Colors.palette.m3tertiaryContainer
                        onColor: isCurrent ? Colors.palette.m3onSurface : Colors.palette.m3onTertiaryContainer
                        text: wsId
                        disabled: isCurrent
                    ...
                    RowLayout {
                        ...
                        Button {
                            ...
                            onColor: Colors.palette.m3onSecondaryContainer
                            ...
                            Loader {
                                ...
                                sourceComponent: Button {
                                    ...
                                    Button {
                                        ...
                                        onColor: Colors.palette.m3onErrorContainer
                                        text: qsTr("Kill")
                                        ...
                                        component Button: StyledRect {
                                            property color onColor: Colors.palette.m3onSurface
