...
Item {
    ...
    ColumnLayout {
        ...
        StyledText {
            ...
            color: Players.active ? Colors.palette.m3primary : Colors.palette.m3onSurface
        ...
        StyledText {
            ...
            color: Players.active ? Colors.palette.m3secondary : Colors.palette.m3outline
        ...
        RowLayout {
            ...
            StyledRect {
                ...
                color: {
                    ...
                    return Qt.alpha(Colors.palette.m3onSurface, 0.1);
                    return Players.active?.isPlaying ? Colors.palette.m3primary : Colors.palette.m3primaryContainer;
                }

                StateLayer {
                    disabled: !Players.active?.canTogglePlaying
                    color: Players.active?.isPlaying ? Colors.palette.m3onPrimary : Colors.palette.m3onPrimaryContainer
                ...
                MaterialIcon {
                    ...
                    color: {
                        if (!Players.active?.canTogglePlaying)
                        return Qt.alpha(Colors.palette.m3onSurface, 0.38);
                        return Players.active?.isPlaying ? Colors.palette.m3onPrimary : Colors.palette.m3onPrimaryContainer;
                    }
            ...
            StyledRect {
                ...
                RowLayout {
                    ...
                    StyledText {
                        ...
                        color: Players.active ? Colors.palette.m3onSurface : Colors.palette.m3onSurfaceVariant
                        elide: Text.ElideRight
                    }
                }
    ...
    component PlayerControl: StyledRect {
        ...
        MaterialIcon {
            ...
            text: control.icon
            color: control.canUse ? Colors.palette.m3onSurface : Colors.palette.m3outline
