...
StyledRect {
                ...
                sourceComponent: StyledRect {
                    ...
                    Loader {
                        ...
                        sourceComponent: ColouredIcon {
                            ...
                            colour: root.modelData.urgency === NotificationUrgency.Critical ? Colors.palette.m3onError : root.modelData.urgency === NotificationUrgency.Low ? Colors.palette.m3onSurface : Colors.palette.m3onSecondaryContainer
    ...
    component Action: StyledRect {
        ...
        radius: Appearance.rounding.full
        color: root.modelData.urgency === NotificationUrgency.Critical ? Colors.palette.m3secondary : Colors.layer(Colors.palette.m3surfaceContainerHigh, 2)
        ...
        StateLayer {
            radius: Appearance.rounding.full
            color: root.modelData.urgency === NotificationUrgency.Critical ? Colors.palette.m3onSecondary : Colors.palette.m3onSurface
        ...
        StyledText {
            ...
            color: root.modelData.urgency === NotificationUrgency.Critical ? Colors.palette.m3onSecondary : Colors.palette.m3onSurfaceVariant
            font.pointSize: Appearance.font.size.small
        }
