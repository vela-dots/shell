...
Item {
    ...
    component PlayerControl: StyledRect {
        ...
        color: active ? Colors.palette[`m3${color.toLowerCase()}`] : Colors.palette[`m3${color.toLowerCase()}Container`]
        ...
        StateLayer {
            ...
            color: control.active ? Colors.palette[`m3on${control.color}`] : Colors.palette[`m3on${control.color}Container`]
