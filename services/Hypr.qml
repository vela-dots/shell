...
Singleton {
    ...
    FileView {
        ...
        path: Quickshell.env("VELA_XKB_RULES_PATH") || "/usr/share/X11/xkb/rules/base.lst"
        onLoaded: {
    ...
    Process {
        ...
        running: true
        command: ["hyprctl", "--batch", "keyword bindln ,Caps_Lock,global,vela:reloadDevices;keyword bindln ,Num_Lock,global,vela:reloadDevices"]
    }
