...
Switch {
    ...
    indicator: StyledRect {
        ...
        color: root.checked ? Colors.palette.m3primary : Colors.layer(Colors.palette.m3surfaceContainerHighest, root.cLayer)
        ...
        StyledRect {
            ...
            radius: Appearance.rounding.full
            color: root.checked ? Colors.palette.m3onPrimary : Colors.layer(Colors.palette.m3outline, root.cLayer + 1)
