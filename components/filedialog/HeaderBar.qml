    ...
    RowLayout {
        ...
        Item {
            ...
            MaterialIcon {
                ...
                color: root.dialog.cwd.length === 1 ? Colors.palette.m3outline : Colors.palette.m3onSurface
                grade: 200
            }
        }
                        ...
                        Item {
                            ...
                            Loader {
                                ...
                                sourceComponent: MaterialIcon {
                                    text: "home"
                                    color: root.dialog.cwd.length === 1 ? Colors.palette.m3onSurface : Colors.palette.m3onSurfaceVariant
                                    fill: 1
                                }
                            }
                            ...
                            StyledText {
                                ...
                                color: folder.index < root.dialog.cwd.length - 1 ? Colors.palette.m3onSurfaceVariant : Colors.palette.m3onSurface
                                font.bold: true
                            }
                        }
                    }
