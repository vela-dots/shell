...
public:
    ...
    Q_INVOKABLE void getDominantColor(QQuickItem* item, QJSValue callback);
    Q_INVOKABLE void getDominantColor(QQuickItem* item, int rescaleSize, QJSValue callback);
    Q_INVOKABLE void getDominantColor(const QString& path, QJSValue callback);
    Q_INVOKABLE void getDominantColor(const QString& path, int rescaleSize, QJSValue callback);
...
private:
    QColor findDominantColor(const QImage& image, int rescaleSize) const;
